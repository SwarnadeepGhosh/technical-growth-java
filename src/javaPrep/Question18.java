...
the plaintext or messages is shifted by a number of places down the alphabet. For
example,with a shift of 1, P would be replaced by Q, Q would become R, and so on.
...
receiver may decrypt it. Key is the number of OFFSET to shift the cipher alphabet.
